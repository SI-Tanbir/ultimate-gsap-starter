...
// Animate the card in, then make it draggable and keep the yoyo effect running even after dragging
gsap.to('.card', {
  opacity: 1,
  scale: 1,
  duration: 1,
  onComplete: () => {
    // Create the yoyo animation and store its instance
    ...
    Draggable.create('.card', {
      ...
      onRelease() {
        // After dragging, resume the floating animation
        floatTween.resume();
        // Ensure the yoyo effect continues from the current position
